  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.mb-4
      ...
      .col.col-lg-9.col-12.order-lg-1.order-2
        p.mb-3(data-aos="fade-down") La negociación aplicada a las ventas constituye una competencia transversal para los contextos comerciales contemporáneos, porque integra análisis del cliente, comunicación efectiva, manejo ético de la información y toma de decisiones orientada al logro de acuerdos sostenibles. En este marco, negociar no significa imponer una posición, sino construir propuestas de valor que permitan conciliar intereses organizacionales y necesidades del cliente mediante procesos estructurados y argumentados.
        .cajon.c1.p-3
